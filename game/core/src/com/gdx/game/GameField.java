...
public class GameField implements Screen {
    ...
    public GameField(createScreen game) {
        ...
        assetManager.load("Sound/die.ogg", Sound .class);
        assetManager.load("Sound/early-sunrise.ogg",Sound.class);
    ...
    @Override
    public void show() {
        backgroundSound=assetManager.get("Sound/early-sunrise.ogg");
